...
namespace QLearningIamNotSureWhetherICanAddExtraHeaderFilesDuringSubmission
{
class LinearApprox{
public:
...
private:
	...
	std::shared_ptr<QLearningIamNotSureWhetherICanAddExtraHeaderFilesDuringSubmission::LinearApprox> approximator;
