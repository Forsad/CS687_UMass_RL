...
public:
	...
	virtual void getFeatures(const Eigen::VectorXd& s, int action, Eigen::VectorXd &feats) const = 0;
	...
	void dqwsa(const Eigen::VectorXd& s, int action, Eigen::VectorXd &grad) const {
		getFeatures(s, action, grad);
	}

	double qwsa(const Eigen::VectorXd& s, int action) const {
...
public:
	...
	void getFeatures(const Eigen::VectorXd& s, int action, Eigen::VectorXd &feats) const override{
...
public:
	...
	void incrementFourierCounter(Eigen::VectorXd & buff, const int& maxDigit) const {
